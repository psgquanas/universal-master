...
export default function VerifyEmailScreen() {
  ...
  const verifyEmail = async () => {
    ...
    if (!email) {
      setError(
        "Your email address is missing. Return to sign up and try again.",
      );
      return;
    }
      ...
      >
        ...
        >
          ...
          <Text style={styles.subtitle}>
            ...
            {email || "your email address"} to finish creating your account.
          </Text>
...
const createStyles = (theme: ReturnType<typeof useTheme>) =>
  StyleSheet.create({
    ...
    content: {
      flexGrow: 1,
      padding: 24,
      paddingTop: Platform.OS === "ios" ? 34 : 28,
      paddingBottom: 40,
    },
    backButton: {
      width: 40,
